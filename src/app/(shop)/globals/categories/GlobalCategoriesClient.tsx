...
import { createGlobalCategory } from "@/lib/actions/globals";

export default function GlobalCategoriesClient({
    initialCategories,
}: {
    ...
    const handleCreate = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const newCat = await createGlobalCategory(newName);
