...
import { AdminOffer, CreateOfferPayload, createShopOffer, stopShopOffer } from "@/lib/actions/offers";
...
function OfferCard({
    ...
    const handleStop = () => {
        ...
        startStop(async () => {
            await stopShopOffer(shopId, offer.offerId);
            onStopped();
        });
    };
...
function CreateOfferModal({
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        startTransition(async () => {
            const result = await createShopOffer(shopId, payload);
            if (result.success) {
                onCreated();
                onClose();
            } else {
        ...
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 py-2 px-1">
                <div className="space-y-1">
                    ...
                    <p className="text-[10px] font-black text-gray-400 uppercase tracking-widest pl-0.5">
                        {shopName}
                    </p>
                </div>
                <button
